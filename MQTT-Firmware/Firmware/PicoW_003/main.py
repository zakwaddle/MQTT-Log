...
def main():
    ...
    try:
        motion1 = setup_motion_sensor(client=home_client, device_info=device_info, **sensors['motion1'])
    except Exception as er:
        home_client.log(f"Motion1 Error: {er}")
        print("\nMotion1 Error:\n\t", er, "\n")

    try:
        motion2 = setup_motion_sensor(client=home_client, device_info=device_info, **sensors['motion2'])
    except Exception as er:
        home_client.log(f"Motion2 Error: {er}")
        print("\nMotion2 Error:\n\t", er, "\n")
